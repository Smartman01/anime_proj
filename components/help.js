    ...
    return (
        <div>
            <ol type='1' style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: minWidth ? 'center' : 'start'}}>
                ...
                <Image style={{transform: `translate(${minWidth ? -20 : 20}px, 0px)`, borderRadius: 10, border: '2px solid red'}} src='/anime_proj/images/search.png' width={200/(minWidth ? 1 : 0.566666667)} height={200*(minWidth ? 0.566666667 : 1)}/>
                ...
                <Image style={{transform: `translate(${minWidth ? -20 : 20}px, 0px)`, borderRadius: 10, border: '2px solid red'}} src='/anime_proj/images/incorrect.png' width={minWidth ? 220 : 120/0.3448} height={minWidth ? 220*0.3448 : 120}/>
            </ol>
        </div>
    );
}
